...
public class tictactoe extends JFrame {
	...
	public void button11ActionPerformed(ActionEvent e) {
		...
		if (JOptionPane.showConfirmDialog(frame, "Are you sure want to exit !!",
				"Tic Tac Toe Develop by Rahi",
	...
	public void initComponents() {
		...
		// ======== this ========
		setTitle("Tic Tac Toe Developed by Rahi");
		Container contentPane = getContentPane();

		// ---- button1 ----
		button1.setFont(new Font("Tahoma", Font.BOLD, 75));
		button1.setText("");
		...
		// ---- button2 ----
		button2.setFont(new Font("Tahoma", Font.BOLD, 75));
		button2.setText("");
		...
		// ---- button3 ----
		button3.setFont(new Font("Tahoma", Font.BOLD, 75));
		button3.setText("");
		...
		// ---- button4 ----
		button4.setFont(new Font("Tahoma", Font.BOLD, 75));
		button4.setText("");
		...
		// ---- button5 ----
		button5.setFont(new Font("Tahoma", Font.BOLD, 75));
		button5.setText("");
		...
		// ---- button6 ----
		button6.setFont(new Font("Tahoma", Font.BOLD, 75));
		button6.setText("");
		...
		// ---- button7 ----
		button7.setFont(new Font("Tahoma", Font.BOLD, 75));
		button7.setText("");
		...
		// ---- button8 ----
		button8.setFont(new Font("Tahoma", Font.BOLD, 75));
		button8.setText("");
		...
		// ---- button9 ----
		button9.setFont(new Font("Tahoma", Font.BOLD, 75));
		button9.setText("");
		...
		// -------resetbutton-----
		button10.setFont(new Font("Tahoma", Font.BOLD, 25));
		...
		button11.setFont(new Font("Tahoma", Font.BOLD, 25));
		...
		contentPaneLayout.setHorizontalGroup(contentPaneLayout.createParallelGroup().addGroup(contentPaneLayout
				...
				.addGroup(contentPaneLayout.createParallelGroup()
						...
						.addGroup(contentPaneLayout.createSequentialGroup()
								.addComponent(button10, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
		...
		contentPaneLayout.setVerticalGroup(contentPaneLayout.createParallelGroup()
				.addGroup(contentPaneLayout.createSequentialGroup().addContainerGap()
						...
						.addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								...
								.addComponent(button6, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(button7, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
								.addComponent(button8, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
								.addComponent(button9, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
								.addComponent(button10, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
								.addComponent(button11, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
